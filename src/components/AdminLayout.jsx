...
const AdminLayout = ({ title, subtitle, onLogout, children }) => {
	return (
		<div className="min-h-[70vh] w-full">
			<div className="grid min-h-[70vh] grid-cols-1 lg:grid-cols-[260px_1fr] gap-6">
				<aside className="glass-card border border-white/10 rounded-2xl p-5 h-fit lg:h-full">
					<div className="mb-6">
